...
from files.views import RegisterView, LoginView, LogoutView, FileCreateView, FileReadView, FileDetailReadView, FileUpdateView, FileDeleteView,FileLinkView, FileDownloadView
